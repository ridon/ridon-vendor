...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/ridon/prebuilt/common/bootanimation))
...
PRODUCT_BOOTANIMATION := vendor/ridon/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip
else
PRODUCT_BOOTANIMATION := vendor/ridon/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip
endif
endif
